...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO Professor Music SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of Professor Music Music Started")
    print("[INFO]: STARTED THE Professor Music BOT AND SENDING THE INFO TO Professor Music SERVER")
